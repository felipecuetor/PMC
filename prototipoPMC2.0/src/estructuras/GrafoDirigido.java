 ...
 * 
 * @param <K>
 *            Tipo del identificador de un vértice
 * @param <V>
 *            Tipo de datos del elemento del vértice
 * @param <A>
...
public class GrafoDirigido<K, V extends IVertice<K>, A extends IArco>
	 ...
	 * @return <code>true</code> si el vértice con el identificador dado existe
	...
	/**
	 * Devuelve todos los vértices del grafo. </p> Este método retorna los
	 * objetos Vertice, propios de está implementación.
	 * 
	 ...
	 * 
	 * @param idV1
	 *            id del primer vértice
	 * @param idV2
	 *            id del segundo vértice
	 * @return El arco entre los vértices ingresados por parametros
	 * @throws Exception
	 *             si alguno de los vértices ingresados por parametros no existe
	 *             en el grafo
	 * @throws Exception
	 *             si no existe un arco entre esos vértices
	 */
	public IArco darArco(K idVerticeOrigen, K idVerticeDestino)
		...
		if (existeVertice(idVerticeDestino)) {
			...
			if (arco == null)
				throw new Exception(
						"No existe un arco entre los vértices seleccionados");
			else
	 ...
	 * @param idV2
	 *            id del segundo vértice
	 * @return <code>true</code> si existe un arco entre los vértices ingresado
	 *         o <code>false</code> en caso contrario.
	 * @throws Exception
	 *             si alguno de los vértices ingresados por parametros no existe
	 *             en el grafo
	...
	/**
	 * Devuelve los id de los vértice sucedores a un vértice ingresado por
	 * parámetro
	 * 
	 * @param idVertice
	 *            Identificador del vértice
	 * @return Los id de los vértice sucedores a un vértice ingresado por
	 *         parámetro
	 * @throws Exception
	 *             Si el vértice especificado no existe
	 */
	...
	/**
	 * Devuelve los id de los vértice predecesores a un vértice ingresado por
	 * parámetro
	 * 
	 * @param idVertice
	 *            Identificador del vértice
	 * @return Los id de los vértice predecesores a un vértice ingresado por
	 *         parámetro
	 * @throws Exception
	 *             Si el vértice especificado no existe
	 */
	 ...
	 * 
	 * @param elemento
	 *            Elemento del vértice
	 * @throws Exception
	 *             Si el vértice que se quiere agregar ya existe
	 */
	 ...
	 *            Identificador del vértice
	 * @throws Exception
	 *             suando el vértice especificado no existe
	 */
	 ...
	 *            Identificador del vértice desde donde sale el arco
	 * @param idVerticeDestino
	 *            Identificador del vértice hasta donde llega el arco
	 * @param infoArco
	 *            Elemento del arco
	 * @throws Exception
	 *             Si alguno de los vértices especificados no existe
	 * @throws ArcoYaExisteException
	 *             Si ya existe un arco entre esos dos vértices
	 */
	 ...
	 *            Identificador del vértice hasta donde llega el arco
	 * @throws Exception
	 *             Cuando el vértice de salida no existe
	 * @throws Exception
	 ...
	 * número de vértices que tiene este
	 * 
	 ...
	 * @param idVerticeDestino
	 *            Vértice de destino
	 * @return <code>true</code> si hay camino entre los dos vértices
	 *         especificados o <code>false</code> de lo contrario
	 * @throws Exception
	 *             Si no existe alguno de los dos vértices dados
	 */
	 ...
	 * 
	 * @param idVerticeOrigen
	 *            Vértice en el que inicia el camino
	 * @param idVerticeDestino
	 *            Vértice en el que termina el camino
	 * @return El camino más corto entre el par de vértices especificados
	 * @throws Exception
	 *             Si alguno de los dos vértices no existe
	 */
	 ...
	 * entre cualquier pareja de vértices en el grafo.
	 * 
	 ...
	 *         todos su vÃ©rtices tengan excentricidad infinita
	 */
	 ...
	 * @param idVertice
	 *            Id del vertice
	 * @return La excentricidad del vértice ingresado por parámetro, o
	 *         Grafo.INFINITO en caso no poder alcanzar alguno de los vértices
	 *         del grafo.
	 * @throws Exception
	 *             Si el vértice buscado no existe
	 */
	 ...
	 * @throws Exception
	 *             Excepción generada cuando el vértice buscado no existe en el
	 *             grafo
	 */
